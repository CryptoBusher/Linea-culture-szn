...
2. Скачиваем проект (архивом либо через "git clone" (см. "Как подтягивать обновления")), в терминале, находясь в папке проекта, вписываем команду "npm i" для установки всех зависимостей
